  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          SliverToBoxAdapter(child: _TodaySummaryCard(sessionsAsync: sessionsAsync)),
                    ...
                    children: [
                      Text(
                        ...
                        style: Theme.of(context)
                            .textTheme
                            .bodySmall
                            ?.copyWith(color: colorScheme.onPrimaryContainer.withOpacity(0.7)),
                      ),
    ...
    return Card(
      child: ListTile(
        leading: CircleAvatar(
          ...
          child:
              Icon(Icons.pool, color: colorScheme.onSecondaryContainer, size: 20),
        ),
        title: Text(
